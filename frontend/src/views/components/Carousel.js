...
export const CarouselData = [
  {
    image: "./assets/images/johannes-plenio-RwHv7LgeC7s-unsplash.jpg",
    data: ["Join", "Bootcamp", "Join with us and work in your dream company", "signin"],
  },
  {
    image: "./assets/images/rosie-sun-1L71sPT5XKc-unsplash.jpg",
    data: ["Need", "Talent ?", "Trusted development partner in provide skillfull IT resource", "#"],
  },
  {
    image: "./assets/images/tobias-tullius-RhjVGxILcqE-unsplash.jpg",
  ...
  render() {
    return (
      <div className="overflow-hidden">
        <div className="w-full h-screen flex overflow-hidden relative rounded-2xl">
